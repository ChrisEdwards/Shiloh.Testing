...
namespace Shiloh.Common.Specs
{
	...
	public class Enforcing_that_a_parameter_is_not_null
	{
		...
		private Because of = () => Exception = Catch.Exception( () => TestMethod( _parameterToTest ) );
	...
	{
		private Establish context = () => _parameterToTest = null;
	...
	{
		private Establish context = () => _parameterToTest = "this is not null";
	...
	{
		private Establish context = () => _valueToTest = null;
		private It should_fail = () => Exception.ShouldBeOfType< ArgumentException >();
	}
	...
	{
		private Establish context = () => _valueToTest = "this is not null";
		private It should_pass = () => Exception.ShouldBeNull();
	}
	...
	{
		private Because of = () => Exception = Catch.Exception( () => TestMethod( _stringParameter ) );
		private It should_pass = () => Exception.ShouldBeNull();
	}
	...
	{
		private Because of = () => Exception = Catch.Exception( () => TestMethod( _intParameter ) );
		private It should_fail = () => Exception.ShouldBeOfType< ArgumentException >();
	}
	...
	{
		private Because of = () => Exception = Catch.Exception( () => TestMethod( new DateTime( 2011, 02, 03 ) ) );
		private It should_pass = () => Exception.ShouldBeNull();
	}
	...
	{
		private Because of = () => Exception = Catch.Exception( () => TestMethod( new DateTime( 2011, 02, 03, 8, 50, 0 ) ) );
		private It should_fail = () => Exception.ShouldBeOfType< ArgumentException >();
	}
	...
	public class Enforcing_that_a_date_value_has_no_time
	{
		...
		protected static Exception Exception;
		private Because of = () => Exception = Catch.Exception( () => Enforce.IsDateWithoutTime( _dateTimeValue ) );
	}
	...
	{
		private Establish context = () => _dateTimeValue = new DateTime( 2011, 02, 03 );
		private It should_pass = () => Exception.ShouldBeNull();
	}
