...
namespace Shiloh.Common.Specs.Extensions
{
	public class When_joining_an_enumberable_into_a_delimited_string
	{
		...
		Because of = () => _result = _items.AsDelimitedString( "," );
	}
	...
	{
		Establish context = () => _items = new List< string > { "1", "2", "3" };
		It should_return_the_items_separated_by_the_specified_delimiter = () => _result.ShouldEqual( "1,2,3" );
	}
	...
	{
		Establish context = () => _items = new List< string > { "1" };
		It should_return_the_single_item_without_the_delimiter = () => _result.ShouldEqual( "1" );
	}
	...
	{
		Establish context = () => _items = new List< string >();
