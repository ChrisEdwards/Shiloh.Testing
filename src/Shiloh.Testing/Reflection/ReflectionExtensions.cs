...
namespace Shiloh.Testing.Reflection
{
	public static class ReflectionExtensions
	{
		...
		/// </summary>
		/// <param name="type">The type to get public properties from..</param>
		/// <returns>All the properties with a public getter.</returns>
		...
		/// <returns>All properties with a public getter and no public setter.</returns>
...
// 		}
		...
		public static void SetProperty( this object instance, PropertyInfo propertyInfo, object propertyValue )
		{
			...
			{
				throw new ApplicationException( "Error occurred while setting default value for property [" +
